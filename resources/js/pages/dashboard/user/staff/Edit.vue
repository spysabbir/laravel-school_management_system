...
const form = useForm<{
    ...
    status: user.staff?.status || 'Running',
    resignation_date: user.staff?.resignation_date || '',
    retirement_date: user.staff?.retirement_date || '',
    suspension_date: user.staff?.suspension_date || '',
    resignation_reason: user.staff?.resignation_reason || '',
    suspension_reason: user.staff?.suspension_reason || '',
});

const submit = () => {
    form.put(route('staffs.update', user.id), {
            onSuccess: () => {
