...
import { type BreadcrumbItem, type ExpenseCategory, type Expense } from '@/types';
...
import { CalendarDate, DateFormatter, getLocalTimeZone, today, type DateValue, parseDate  } from '@internationalized/date'
...
if (props.expense.date) {
    dateValue.value = parseDate(props.expense.date)
}

const form = useForm({
    expense_category_id: String(props.expense.expense_category_id),
